...
public class ProgressManagerImplDk1 extends ProgressManager {
    ...
    public void saveProgress(String url, long progress) {
        ...
        Log.e("VideoPlayerAct-saveProgress", Long.parseLong(SPUtils.getInstance().getString(String.valueOf(url), "0")) + "");
        SPUtils.getInstance().put(String.valueOf(url), progress+"");
    }
