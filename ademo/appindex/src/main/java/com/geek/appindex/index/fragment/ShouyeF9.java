...
public class ShouyeF9 extends SlbBaseLazyFragmentNew implements FsyyyView, FWechatJump1View, FBannerView, FAppCheckUseView {
...
//        list.add(new DataBean(R.drawable.img_bkg, "生活的态度", 3));
    ...
    public static ShouyeF9 getInstance(Bundle bundle) {
        ShouyeF9 mEasyWebFragment = new ShouyeF9();
        if (bundle != null) {
...
//            mAdapter.notifyDataSetChanged();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_shouyef9;
    }
...
//        fBannerPresenter.getBannerList(AppCommonUtils.auth_url + "/getplaypic", tablayoutId);
        fBannerPresenter.getBannerList("/gwapi/workbenchserver", "1006", "1");//数字乡村
...
//        ToastUtils.showLong("下拉刷新啦");
    ...
    private void setData() {
        BjyyBeanYewu1 bjyyBeanYewu1 = MmkvUtils.getInstance().get_common_json("ShouyeF9应用列表", BjyyBeanYewu1.class);
        mList = new ArrayList<>();
...
//        bjyyBeanYewu1 = getInitData();
        bjyyBeanYewu1 = bean;
        MmkvUtils.getInstance().set_common_json2("ShouyeF9应用列表", bjyyBeanYewu1);
        setData();
    }
