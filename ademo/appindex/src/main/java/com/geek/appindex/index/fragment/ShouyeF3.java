...
public class ShouyeF3 extends SlbBaseLazyFragmentNew {
    ...
    public static ShouyeF3 getInstance(Bundle bundle) {
        ShouyeF3 mEasyWebFragment = new ShouyeF3();
        if (bundle != null) {
...
//                startActivity(new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.PictureSelectorSimpleActivity"));
        ...
        rootView.findViewById(R.id.tv36).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://cdn2.cdn.haier-jiuzhidao.com/appplugin-bxn_nation-debug.apk";
                    ...
                    public void completed(BaseDownloadTask task) {
                        ...
                        getActivity().getWindow().getDecorView().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
//                                    PluginManager.INSTANCE.loadApk(getActivity(), AssetUtil.copyAssetToCache(getActivity(),"appplugin-bxn_nation-debug.apk"), pkgname);
        ...
        rootView.findViewById(R.id.tv37).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.QuanxianActivity"));
            }
        });
        rootView.findViewById(R.id.tv38).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.TablayoutAct"));
            }
        });
    }
