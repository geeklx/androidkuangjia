...
public class DragImageView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public void setUp(Bitmap cover, Bitmap block) {
        ...
        l.width = MSizeUtils.dp2px(getContext(), (float) w);
        l.height = MSizeUtils.dp2px(getContext(), (float) h);
        ...
        layoutParams2.width = MSizeUtils.dp2px(getContext(), (float) block.getWidth());
        layoutParams2.height = MSizeUtils.dp2px(getContext(), (float) block.getHeight());
    ...
    private void setLocation(float cover_wph, int cover_w) {
        ...
        layoutParams.width = MSizeUtils.dp2px(getContext(), (float) w);
        layoutParams.height = MSizeUtils.dp2px(getContext(), (float) h);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (dragListenner != null) {
            dragListenner.onDrag(MSizeUtils.px2dp(
