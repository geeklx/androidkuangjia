...
//              .useDefaultIndicator(getIndicatorColor(), getIndicatorHeight())
        ...
        settings.setUserAgentString(settings.getUserAgentString().concat("dtphone"));
        javainterface();
    }
    ...
    protected PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            if (itemId == R.id.refresh) {
                ...
                if (mAgentWeb != null) {
                    AgentUtils.toCopy(H5AgentWebFragment.this.getActivity(), mAgentWeb.getWebCreator().getWebView().getUrl());
                }
                return true;
            } else if (itemId == R.id.default_browser) {
                if (mAgentWeb != null) {
                    AgentUtils.openBrowser(H5AgentWebFragment.this.getActivity(), mAgentWeb.getWebCreator().getWebView().getUrl());
                }
                return true;
...
//    }
    ...
    IAgentWebSettings getAgentWebSettings() {
        AbsAgentWebSettings absAgentWebSettings = AgentWebSettingsImpl.getInstance();
