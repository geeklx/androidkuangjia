...
import com.geek.appcommon.wechat.WeChatH5JsWebActivity;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.tv_bottom_list) {
            new XPopup.Builder(PopviewDemoAct.this)
                    .autoDismiss(false)
                    .asBottomList("标题", new String[]{"拍照", "相册"},
            ...
            new XPopup.Builder(PopviewDemoAct.this)
                    .borderRadius(30)
                    .isDestroyOnDismiss(true)
                    .asConfirm("标题", "我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容。",
                            "取消", "确定",
            ...
            builder.dismissOnTouchOutside(false)
                    .isDestroyOnDismiss(true);
            ConfirmPopupView confirmPopupView = builder.asConfirm("标题",
                    "我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容",
                    null, "确定",
                    new OnConfirmListener() {
                        @Override
...
//                        .autoFocusEditText(false) //是否让弹窗内的EditText自动获取焦点，默认是true
                    ...
                    .asInputConfirm("我是标题", "我是内容", null, "我是默认Hint文字",
...
//                        .bindLayout(R.layout.my_custom_attach_popup) //自定义布局
            ...
            new XPopup.Builder(PopviewDemoAct.this)
                    ...
                    .asCustom(new CustomAttachPopup(PopviewDemoAct.this))
                    .show();
...
//                    shareBean.imageUrl = "https://www.dtdjzx.gov.cn/u/cms/dtdjzx/202111/15155729f9n7.jpg";
            ...
            new XPopup.Builder(PopviewDemoAct.this)
                    //半透明阴影背
                    .hasShadowBg(true)
                    .asCustom(new FSharePopupView(PopviewDemoAct.this, shareBean))
                    .show();
