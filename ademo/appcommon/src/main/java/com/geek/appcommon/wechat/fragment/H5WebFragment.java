...
import com.geek.appcommon.wechat.bean.DTFgrxxBean;
import com.geek.appcommon.wechat.bean.DTRegionBean;
import com.geek.appcommon.wechat.share.ShareDialog;
...
//              HiosHelperNew.resolveAd(getActivity(), getActivity(), "dataability://" + AppUtils.getAppPackageName() + ".hs.act.slbapp.H5WebAct{act}?url=" + data);
    ...
    protected String getUrl() {
        ...
        String url = bundle.getString(AgentWebFragment.URL_KEY);
