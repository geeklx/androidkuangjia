...
//        mList.add(new BjyyBeanYewu3("id4", "", "", "", "标题4", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题5", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题6", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题7", AppCommonUtils.TAG_f1, false));
        return mList;
    }
...
//        mList.add(new BjyyBeanYewu3("id5", "", "", "", "标题7", AppCommonUtils.TAG_f1, false));
    ...
    public List<BjyyBeanYewu3> addList4() {
        List<BjyyBeanYewu3> mList = new ArrayList<>();
        mList.add(new BjyyBeanYewu3("id1", getResources().getString(R.string.tips1more2), "", "", "标题1", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id2", getResources().getString(R.string.tips1more2), "", "", "标题2", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id3", getResources().getString(R.string.tips1more2), "", "", "标题3", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id4", getResources().getString(R.string.tips1more2), "", "", "标题4", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题5", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题6", AppCommonUtils.TAG_f1, false));
        mList.add(new BjyyBeanYewu3("id5", getResources().getString(R.string.tips1more2), "", "", "标题7", AppCommonUtils.TAG_f1, false));
        return mList;
