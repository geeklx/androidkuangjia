 ...
 * @since 2017/4/15
 */
public class DTYTXSearchViewHelper {
     ...
     * 搜索功能实现接口
     */
    public YTXISearch mSearchImpl;
    /**
     * 搜索框左边图标
     */
    private final int inputDrawableLeft;
     ...
     */
    public DTYTXSearchViewHelper(boolean normal) {
        dynamicExpand = false;
        ...
        TAG = "RongXin.SearchViewHelper" + System.currentTimeMillis();
    }
    ...
    public void onCreateOptionsMenu(final FragmentActivity activity, Menu menu) {
        ...
        if (activity == null) {
            ...
            if (mSearchImpl == null) {
                mSearchImpl = new DTYTXActionBarSearchView(activity);
            }

            mSearchImpl.setOnActionBarSearchListener(new YTXISearch.OnActionBarSearchListener() {
                @Override
            ...
            mMenuItem = menu.add(0, R.id.ytx_action_bar_search, 0, activity.getString(R.string.app_search));
            mMenuItem.setEnabled(canExpand);
            mMenuItem.setIcon(R.mipmap.ytx_theme_icon_search_24);
            ...
            mSearchImpl.setOnActionBarNavigationListener(new YTXISearch.OnActionBarNavigationListener() {
                @Override
