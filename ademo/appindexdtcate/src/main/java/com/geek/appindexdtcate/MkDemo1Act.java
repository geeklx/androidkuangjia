...
import com.geek.appindexdtcate.demo.factorys.MkDemo1ActFragmentFactory;
...
public class MkDemo1Act extends SlbBaseActivity implements OnClickListener {

    @Override
    protected int getLayoutId() {
        return R.layout.activity_mk_demo1act;
    }
    ...
    private void setupFragments() {
        ...
        SparseArrayCompat<Class<? extends SlbBaseFragment>> array = MkDemo1ActFragmentFactory.get();//一个版本模式bufen
        int size = array.size();
