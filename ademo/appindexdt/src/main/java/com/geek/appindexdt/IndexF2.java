...
public class IndexF2 extends SlbBaseLazyFragmentNew implements View.OnClickListener {
    ...
    public class MessageReceiverIndex extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                if ("IndexF2".equals(intent.getAction())) {
                    //TODO 发送广播bufen
                    Intent msgIntent = new Intent();
                    msgIntent.setAction("IndexF2");
...
//        Bundle arg = getArguments();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_indexf2;
    }
