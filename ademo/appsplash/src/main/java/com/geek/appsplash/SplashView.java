...
public class SplashView extends FrameLayout {
    ...
    private static OnSplashViewActionListener mOnSplashViewActionListener = null;

    private Handler handler = new Handler(Looper.getMainLooper());
    private Runnable timerRunnable = new Runnable() {
        @Override
        public void run() {
            Log.e("aaaaaaa", "timerRunnable: " + "执行计数");
            if (0 == duration) {
    ...
    public SplashView(Activity context) {
        super(context);
        Log.e("aaaaaaa", "SplashView: " + "初始化SplashView开始");
        mActivity = context;
        initComponents();
    }
...
//        splashSkipButtonBg.setSize(150,80);
        ...
        setDuration(duration);
        handler.postDelayed(timerRunnable, delayTime);
        Log.e("aaaaaaa", "SplashView: " + "初始化SplashView结束");
    }
...
//        skipButton.setText(String.format("跳过\n%d s", duration));
        ...
        Log.e("aaaaaaa", "setDuration: " + "更新UI");
    }
    ...
    public static void showSplashView(Activity activity,
        ...
        Log.e("aaaaaaa", "showSplashView: " + "开始执行执行showSplashView绘制");
...
//        }
    ...
    public void dismissSplashView(boolean initiativeDismiss) {
        Log.e("aaaaaaa", "dismissSplashView: " + "结束执行dismissSplashView");
    ...
    public static void updateSplashData(Activity activity, String imgUrl, String actionUrl) {
        IMG_PATH = activity.getFilesDir().getAbsolutePath().toString() + "/splash_img.jpg";
        Log.e("aaaaaaa", "updateSplashData: " + "更新数据");
