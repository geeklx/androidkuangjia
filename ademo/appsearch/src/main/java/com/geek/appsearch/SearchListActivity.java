...
public class SearchListActivity extends SlbBase implements View.OnClickListener, SNew1SearchView {
...
//        if (fgrxxBean != null) {
//            presenter.getNew1SearchData1(search_key,fgrxxBean.getUserId(),fgrxxBean.getName(),"-1","3519379523491604669");
//        }
