...
//        File diskCacheDir = getDiskCacheDir(Utils.getApp(), CACHE_DIR);
        File diskCacheDir = getDiskCacheDir2(Utils.getApp(), CACHE_DIR);
        ...
        if (diskCacheDir.getUsableSpace() > DISK_CACHE_SIZE) {
            try {
                mDiskLruCache = DiskLruCache.open(diskCacheDir, getAppVersion(Utils.getApp()), 1/*一个key对应多少个文件*/, DISK_CACHE_SIZE);
