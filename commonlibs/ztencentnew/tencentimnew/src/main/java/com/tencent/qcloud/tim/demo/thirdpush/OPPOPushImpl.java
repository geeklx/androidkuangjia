...
public class OPPOPushImpl implements ICallBackResultService {
    ...
    public void onRegister(int responseCode, String registerID) {
        DemoLog.e("TencentIM", "onRegister responseCode: " + responseCode + " registerID: " + registerID);
    ...
    public void onUnRegister(int responseCode) {
        DemoLog.e("TencentIM", "onUnRegister responseCode: " + responseCode);
    }

    @Override
    public void onSetPushTime(int responseCode, String s) {
        DemoLog.e("TencentIM", "onSetPushTime responseCode: " + responseCode + " s: " + s);
    }

    @Override
    public void onGetPushStatus(int responseCode, int status) {
        DemoLog.e("TencentIM", "onGetPushStatus responseCode: " + responseCode + " status: " + status);
    }

    @Override
    public void onGetNotificationStatus(int responseCode, int status) {
        DemoLog.e("TencentIM", "onGetNotificationStatus responseCode: " + responseCode + " status: " + status);
    }
